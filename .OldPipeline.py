...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.cv_transpose_output = None

        self.__cv_flip_src = self.cv_transpose_output
        self.__cv_flip_flipcode = FlipCode.Y_AXIS
        ...
        self.__rgb_threshold_red = [121.08812949640286, 197.0454545454545]
        self.__rgb_threshold_green = [215.18884892086334, 255.0]
        self.__rgb_threshold_blue = [198.48920863309354, 255.0]
        ...
        self.__filter_contours_max_height = 220.0
        self.__filter_contours_solidity = [100.0, 100.0]
        self.__filter_contours_max_vertices = 25.0
    ...
    def process(self, source0):
        ...
        """
        # Step CV_transpose0:
        self.__cv_transpose_src1 = source0
        (self.cv_transpose_output) = self.__cv_transpose(self.__cv_transpose_src1)
        ...
        #output_list = [self.cv_transpose_output, self.cv_flip_output, self.blur_output, self.rgb_threshold_output, self.convex_hulls_output, self.filter_contours_output]
        #return output_list

    @staticmethod
    def __cv_transpose(src):
